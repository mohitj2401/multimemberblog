...
<html>
  <head>
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('blog-asset/css/style.default.css')}}" id="theme-stylesheet">
        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="{{route('register')}}" class="nav-link active">Login</a>
              </li>
              @else 
